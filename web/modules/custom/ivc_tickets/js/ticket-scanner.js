(function ($, Drupal) {
  Drupal.behaviors.IvcTicketsQRCodeScanner = {
    ...
    attach: function (context, settings) {
      ...
      $('.btn-scan', context).once('IvcTicketsQRCodeScanner').each(function(){
        $('.btn-scan', context).on('click.IvcTicketsQRCodeScanner', function(e) {
          e.preventDefault();
          if (Drupal.behaviors.IvcTicketsQRCodeScanner.html5QrCode !== null) {
            Drupal.behaviors.IvcTicketsQRCodeScanner.html5QrCode.stop();
          }
          Drupal.behaviors.IvcTicketsQRCodeScanner.initQrCode();
        });
      });
